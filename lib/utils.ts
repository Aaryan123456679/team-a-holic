...
export function getContrastingTextColor (
  ...
  const luminence  = 0.299 * color.r + 0.587 * color.g + 0.114 * color.b;

  return luminence > 182 ? "black" : "white"
}
...
export function penPointsToPathLayer (
  ...
  color : Color,
    ...
    if(points.length < 2){
      throw new Error("Cannot transform Layer with less than two points");
    }
